...
public class SQLHelper {
     ...
     */
    public static int getCount(final String sql, String dbname, final Connection connection,
...
//	        countSql = "select count(1) " + removeSelect(removeOrders(sql));
     ...
     * @return 分页SQL
     */
    public static String generatePageSql(String sql, PageResponseBean<Object> page, Dialect dialect) {
